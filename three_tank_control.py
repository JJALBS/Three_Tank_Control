...
def controller_action_selection(controller, set_point, control_variable, dt):
    if isinstance(controller, PID):
        ...
        state = [control_variable/MAX_H, set_point/MAX_H]
        ...
        controller.update_state(control_variable, action)
    else:
        raise ValueError(
...
if __name__ == "__main__":
    ...
    fig, (ax1, ax2) = plt.subplots(nrows=2, ncols=1, sharex=True, figsize=(14, 8), dpi=100,)
