...
if __name__ == "__main__":
    ...
    os.makedirs(r"data\control_result\disturbance_upper_tank", exist_ok=True)
    for i in range(0, 1000):
        filename = rf"data\control_result\disturbance_upper_tank\{config["controller_type"]}_{i}.pickle"
